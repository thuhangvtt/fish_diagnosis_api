...
widget:
- source_sentence: mắt lồi ra ngoài
  sentences:
  - mắt cá nhô lên
  - cá hay lật nghiêng
  - da cá trắng bệch
- source_sentence: há miệng liên tục
  sentences:
  - màu da cá lạ
  - bụng căng như có khí
  - bơi sát mặt nước như lấy oxy
- source_sentence: mất vảy vùng thân
  sentences:
  - mắt cá đỏ và phồng
  - mang cá không còn hồng
  - số lượng cá chết tăng
- source_sentence: cá nổi lềnh bềnh
  sentences:
  - phân lơ lửng sau đuôi
  - cá chao đảo trong nước
  - cá lười ăn mấy hôm nay
- source_sentence: mất vảy vùng thân
  sentences:
  - màu da không đều
  - cá hay nổi đầu buổi sáng
  - mang cá không còn hồng
...
* Samples:
  | sentence_0                          | sentence_1                            | label            |
  |:------------------------------------|:--------------------------------------|:-----------------|
  | <code>cá không lặn được</code>      | <code>cá hay nổi đầu buổi sáng</code> | <code>1.0</code> |
  | <code>bụng cá như sắp nổ</code>     | <code>số lượng cá chết tăng</code>    | <code>0.0</code> |
  | <code>trầy xước làm rụng vảy</code> | <code>da cá có vết xước</code>        | <code>0.0</code> |
